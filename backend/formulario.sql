...
--
-- Servidor: localhost
-- Tiempo de generación: 08-11-2021 a las 15:10:31
...
CREATE TABLE `usuario` (
  ...
  `id_municipio` int(6) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`);
COMMIT;
